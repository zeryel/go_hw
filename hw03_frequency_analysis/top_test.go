...
func TestTop10(t *testing.T) {
	...
	посидеть у огня и послушать какую-нибудь интересную сказку.
		...
		},
		{
			...
			может противостоять этим законам, а может их только ненавидеть. Извечная вера влюбленных и поэтов во всемогущество любви, побеждающей смерть, преследующие нас
			веками слова «любовь сильнее смерти» — ложь. Но такая
			ложь не смешна, она бессмысленна. А вот быть часами, отсчитывающими течение времени, то разбираемыми, то собираемыми снова, в механизме которых, едва конструктор
